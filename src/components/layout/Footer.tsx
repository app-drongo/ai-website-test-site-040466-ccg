...
const DEFAULT_FOOTER = {
  ...
  newsletterDisclaimer:
    'Join our newsletter for industry insights and updates. Unsubscribe anytime.',
  ...
  const footerSections = [
    {
      ...
      links: [
        ...
        { name: 'Enterprise', href: '/enterprise', editableId: 'link-footer-enterprise' },
      ],
    },
    {
      ...
      links: [
        ...
        { name: 'Partnerships', href: '/partnerships', editableId: 'link-footer-partnerships' },
