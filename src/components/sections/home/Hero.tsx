...
const DEFAULT_HERO = {
  ...
  title: 'Build beautiful websites with',
  titleHighlight: 'minimal effort',
  description:
    'Create stunning, conversion-focused landing pages in minutes. Perfect for startups, agencies, and businesses that value clean design and fast results.',
  features: [
  ...
  imageAlt: 'Clean website dashboard',
  statsLabel1: 'Setup Time',
  statsValue1: '5 minutes',
  statsLabel2: 'Conversion',
  statsValue2: '+40% boost',
} as const;
