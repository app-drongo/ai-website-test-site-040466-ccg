...
const DEFAULT_PRICING = {
  ...
  mainDescription:
    'Choose the perfect plan for your testing needs. Start free and scale as you grow. No hidden fees, cancel anytime.',
  billingMonthly: 'Monthly',
  billingAnnual: 'Annual',
  billingAnnualBadge: 'Save 20%',
  plan1Name: 'Free',
  plan1Description: 'Perfect for getting started with basic testing',
  plan1Price: '$0',
  plan1CTA: 'Get Started Free',
  plan1CTAHref: '/',
  plan2Name: 'Pro',
  plan2Description: 'Best for professionals and growing teams',
  plan2Price: '$19',
  plan2Period: '/month',
  ...
  plan3Description: 'For large teams with advanced requirements',
  plan3Price: 'Custom',
  plan3Badge: 'Contact Us',
  plan3CTA: 'Contact Sales',
  plan3CTAHref: '/contact',
  bottomTitle: 'Need a custom solution?',
  bottomDescription:
    'We work with enterprises to create tailored testing solutions that fit your specific workflow and requirements.',
