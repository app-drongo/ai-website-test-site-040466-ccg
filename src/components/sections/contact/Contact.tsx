...
const DEFAULT_CONTACT = {
  ...
  mainDescription:
    "Have questions about our services? Want to discuss your project? We're here to help. Send us a message and we'll get back to you within 24 hours.",
  formTitle: 'Send us a Message',
  formDescription: "Tell us about your project and we'll provide a personalized solution.",
  submitButton: 'Send Message',
  contactSectionTitle: 'Contact Methods',
  method1Title: 'Email Support',
  method1Description: 'Get detailed responses',
  ...
  office1Address: '123 Business District, Suite 200',
  office1Timezone: 'EST (UTC-5)',
  office2City: 'Los Angeles',
  office2Address: '456 Innovation Blvd, Floor 12',
  office2Timezone: 'PST (UTC-8)',
  office3City: 'Chicago',
  office3Address: '789 Commerce Center, Building C',
